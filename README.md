...
- 스터디는 __1월 둘째 주 (10일)__ 부터 시작할 예정입니다. 커리큘럼은 4월 마지막째 주(29일)까지입니다.  
- 매주 월요일, 화요일, 목요일 중 팀원간의 합의를 통해 주 1회 1시간정도 코드 리뷰를 진행합니다. 코드 리뷰는 두 명씩 번갈아 가면서 진행할 예정입니다.  
- 첫 리뷰 세션은 두 팀 모두 제가 진행하도록 하겠습니다.
- __(1일 1커밋!)__ 매일 토픽에 해당하는 문제를 몇 개 뽑아 슬랙에 올릴 예정입니다. 그 중 최소 한 개를 선택해 문제를 푼 뒤 파일을 깃허브 main branch 해당 폴더에 커밋해주시면 됩니다. 한 주간 최소 다섯 문제는 풀어주셔야 합니다.
- __코드 리뷰__: 코드 리뷰는 자신이 한 주간 푼 문제들을 Jupyter notebook 혹은 Python file 에 작성허고, 리뷰 세션에서 다른 사람들과 공유를 합니다.  
